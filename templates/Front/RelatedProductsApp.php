...
$similarProductsSetting = $recommendation_settings['similarProducts'];
...
<div id="mimi-related-products-app" data-platform="wordpress" data-value="<?php echo esc_attr($productID) ?>" data-number-of-product="<?php echo esc_attr($numberOfProduct) ?>" data-recommendation-style="<?php echo esc_attr($recommendationStyle) ?>" data-similar-setting="<?php echo esc_attr($similarProductsSetting) ?>" data-result-color-hover="<?php echo esc_attr($result_color_hover) ?>">
